type Env = {
  ...
  GITHUB_DRIFT_PLAN_WORKFLOW_FILE: string
...
export const env: Env = {
  ...
  GITHUB_PLAN_WORKFLOW_FILE: required("GITHUB_PLAN_WORKFLOW_FILE", "plan_v2.yml"),
  GITHUB_APPLY_WORKFLOW_FILE: required("GITHUB_APPLY_WORKFLOW_FILE", "apply_v2.yml"),
  GITHUB_DESTROY_WORKFLOW_FILE: required("GITHUB_DESTROY_WORKFLOW_FILE", "destroy_v2.yml"),
  GITHUB_CLEANUP_WORKFLOW_FILE: required("GITHUB_CLEANUP_WORKFLOW_FILE", "cleanup_v2.yml"),
  GITHUB_DRIFT_PLAN_WORKFLOW_FILE: required("GITHUB_DRIFT_PLAN_WORKFLOW_FILE", "drift_plan_v2.yml"),
